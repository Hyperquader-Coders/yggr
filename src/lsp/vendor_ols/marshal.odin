...
//
// OLS's JSON marshaller. Unlike core:encoding/json it OMITS nil union
// fields (that is how optional LSP fields are represented) and honors
// `json:"..."` struct tags. Used by src/lsp/client.odin for all outgoing
// messages (see THIRD_PARTY.md). Body copied verbatim from upstream
// server/marshal.odin except the package name.
